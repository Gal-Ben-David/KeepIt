            ...
            {mails.map(mail =>
                <li className={`mail-li ${mail.isRead ? 'read' : ''}`} key={mail.id}>
                    ...
                    <div className="mail-icons">
                        <button onClick={() => onRemoveMail(mail.id, mail)} type="button" className="trash"><img src="assets\img\mail-icons\delete_24dp_202124_FILL0_wght400_GRAD0_opsz24.png" alt="delete" /></button>
